    ...
    >
      ...
      <div className="card-body">
        ...
        <div className="card-actions py-4">
          <button className="btn btn-sm mx-auto absolute bottom-4 normal-case bg-purple-500 text-white shadow-lg border-0 hover:scale-105 duration-300 hover:bg-purple-600">
            Details
          </button>
        </div>
      </div>
